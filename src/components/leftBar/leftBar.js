    ...
    >
      <div className="dsa-content">
        <div className="data-structure">
          ...
          <div
            className={`sub-category ${
              !dataStructureVisible ? "" : "invisible-data-structures"
            }`}
          >
            <div className="linear ">
              ...
              <ul>
                <li
                  className={`${
                    !linearDatastructureVisible ? "" : "visible-linear"
                  }`}
                  onClick={() => {
            ...
            <div className="non-linear ">
              ...
              <ul>
                <li
                  className={` ${
                    !noneLinearDatastructureVisible ? "" : "visible-none-linear"
                  }`}
                  onClick={() => {
                    handleItemClick("bst");
                  }}
        ...
        <div className="algorithms">
          ...
          <div
            className={`sub-category ${
              !algorithmVisible ? "" : "invisible-algorithms"
            }`}
          >
            <div className="search">
              ...
              <ul>
                <li
                  className={`${
                    !searchAlgorithVisible ? "" : "search-visible"
                  }`}
                  onClick={() => {
            ...
            <div className="sorting">
              ...
              <ul>
                <li
                  className={`${
                    !sortingAlgorithVisible ? "" : "sorting-visible"
                  }`}
                  onClick={() => {
